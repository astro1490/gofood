...
echo color("red","| github: astro1490 |\n");
echo color("red","| fanspage :TEAM HOAX|\n");
echo color("red","| Creator : Team Hoax          |\n");
...
// function change(){
        ...
        echo "\n".color("yellow","!] Claim voc GOFOOD022620B2");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD022620B2"}');
